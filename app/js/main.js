$(function() {
  ...
  $('.footer-top__title').on('click', function() {
    ...
    $(this).toggleClass('active'); /* active тут можно нарисовать стрелочку и тогда при свертвании будет типа стрелочка вниз или  в верх */
    /* slideToggle - при клике открывает и при клике закрвывает. Короче можно сделать для футера типа выпадающего меню */
  });
  ...
  $('.blog-page__slider').slick({
    ...
    infinite: false,/* это свойство дает возможность застилить disable ну собственно его подключает т.к. по дефолту стоит бесконечный цикл */
  });
